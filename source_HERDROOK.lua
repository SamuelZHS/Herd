...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì Snork Hub đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
...
local Window = OrionLib:MakeWindow({Name = "Snork Hub", HidePremium = false, IntroText = "NightHub Library", SaveConfig = true, ConfigFolder = "Snork Hub"})
...
OrionLib:MakeNotification({
	Name = "Snork Hub",
	Content = "Snork Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
